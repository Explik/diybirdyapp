...
class FlashcardContentUploadVideoDto(FlashcardContentDto):
    """
    FlashcardContentUploadVideoDto
    """ # noqa: E501
    video_file_name: Optional[StrictStr] = Field(default=None, alias="videoFileName")
    language_id: Optional[StrictStr] = Field(default=None, alias="languageId")
    __properties: ClassVar[List[str]] = ["id", "type", "videoFileName", "languageId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "videoFileName": obj.get("videoFileName"),
