...
class ExerciseInputSelectPlaceholdersDto(ExerciseInputDto):
    """
    ExerciseInputSelectPlaceholdersDto
    """ # noqa: E501
    parts: List[SelectPlaceholdersInputPart]
    options: List[SelectPlaceholdersInputOption]
    __properties: ClassVar[List[str]] = ["id", "type", "sessionId", "parts", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parts": [SelectPlaceholdersInputPart.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None,
            "options": [SelectPlaceholdersInputOption.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
