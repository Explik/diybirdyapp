...
class ExerciseInputArrangeTextOptionsDto(ExerciseInputDto):
    """
    ExerciseInputArrangeTextOptionsDto
    """ # noqa: E501
    value: Optional[StrictStr] = None
    options: List[ArrangeTextOption]
    __properties: ClassVar[List[str]] = ["id", "type", "sessionId", "value", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "options": [ArrangeTextOption.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None
        })
        return _obj
