...
class FlashcardContentUploadAudioDto(FlashcardContentDto):
    """
    FlashcardContentUploadAudioDto
    """ # noqa: E501
    audio_file_name: Optional[StrictStr] = Field(default=None, alias="audioFileName")
    language_id: Optional[StrictStr] = Field(default=None, alias="languageId")
    __properties: ClassVar[List[str]] = ["id", "type", "audioFileName", "languageId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "audioFileName": obj.get("audioFileName"),
