...
class SubmitAnswerRichRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "answer": SubmitAnswerRequest.from_dict(obj["answer"]) if obj.get("answer") is not None else None,
            "files": obj.get("files")
        })
        return _obj
