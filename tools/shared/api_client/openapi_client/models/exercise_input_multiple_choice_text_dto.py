...
class ExerciseInputMultipleChoiceTextDto(ExerciseInputDto):
    """
    ExerciseInputMultipleChoiceTextDto
    """ # noqa: E501
    feedback: Optional[ExerciseInputFeedbackMultipleChoiceTextFeedbackDto] = None
    options: Optional[List[Option]] = None
    value: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "type", "feedback", "options", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "feedback": ExerciseInputFeedbackMultipleChoiceTextFeedbackDto.from_dict(obj["feedback"]) if obj.get("feedback") is not None else None,
