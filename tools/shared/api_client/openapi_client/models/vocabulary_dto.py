...
class VocabularyDto(BaseModel):
    ...
    VocabularyDto
    """ # noqa: E501
    words: Optional[List[VocabularyContentTextDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "words": [VocabularyContentTextDto.from_dict(_item) for _item in obj["words"]] if obj.get("words") is not None else None
        })
        return _obj
