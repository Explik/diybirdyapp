...
/**
 * Creates view flashcard exercises.
 * Shows both sides of a flashcard without requiring any rating or sorting input.
 */
@Component
public class ViewFlashcardExerciseCreationManager implements ExerciseCreationManager {
    @Autowired
    ...
    public ExerciseVertex createExercise(GraphTraversalSource traversalSource, ExerciseCreationContext context) {
        ...
        var command = exerciseCreationService.createExerciseCommand(
                ExerciseSchemas.VIEW_FLASHCARD_EXERCISE,
                exerciseParameters);
