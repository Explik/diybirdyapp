...
/**
 * Creates review flashcard exercises.
 * Shows both sides of a flashcard for review purposes.
 */
@Component
public class ReviewFlashcardExerciseCreationManager implements ExerciseCreationManager {
    @Autowired
